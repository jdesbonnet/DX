...
The 'magic' codes to program the device are actually Code128 codes. So if
...
There are [many free barcode generators](https://www.google.ie/search?q=barcode+generator&oq=barcode+generator) on the internet. One thing to note: because it is a laser scanner you cannot scan off screen: it must be in print.
