...
**Update 2017-10-28** I sucessfully generated programming codes with Javascript barcode generation library JsBarcode. For example a factory reset (STARTB, FNC3, 000B0) can be generated like so:
```
