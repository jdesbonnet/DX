...
character in decimal for regular characters. This table also includes keys (eg up arrow, Home, End etc) which seems more 
arbitrary (but sill in format 1xxx). For example F11 is "1138", down arrow is "1148". Will document this when I get a chance.
